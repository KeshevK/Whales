...
function bars(data)
{
  ...
  var bisect = d3.bisector(function(d) { return d[0]; });
	...
	// Add a rect per nation. Initialize the data at 1800, and set the colors.
 ...
 /* var shadowD2 = svg.append("g")
  ...
  var rect = rect1.append("rect")
      ...
      .on("mouseover", function()
      {
          ...
          var xpos = Number(el.attr('x'))
          var ypos = (el.attr('y') - d.height - 10)
      })
      .on("mouseout", function(){d3.select(this).style("stroke-width", "1");});
  var text = rect1.append("svg:text")
		.call(position_t)
		.attr("font-size","0px")
		.text(function(d){
			var testss = d.name;
...
svg.selectAll("#p2")
 ...
 var tres = "";
  ...
  // Positions the rects based on data.
  ...
  // Defines a sort order so that the smallest rects are drawn on top.
  function order(a, b)
  {
